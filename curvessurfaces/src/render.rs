...
use wgpu::{
    ...
    PolygonMode, PowerPreference, PresentMode, PrimitiveState, PushConstantRange, Queue,
...
impl RenderState {
    pub fn create(window: &Window, models: &[Model]) -> Self {
    ...
    pub fn render(&self) {
            ...
            .create_view(&wgpu::TextureViewDescriptor::default());
        {
            ...
            } in self.models.iter()
            {
                ...
                rpass.set_index_buffer(idx_buffer.slice(..), IndexFormat::Uint32);
