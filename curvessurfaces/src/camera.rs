...
// LITERally I just copied this from
// my obj-viewer project
// it still suits my needs just fine for this project
...
impl SimpleCamera3DController {
    ...
    pub fn camera_update(&self, camera: &mut Camera3D) {
        ...
        // camera.rotation.x -= (self.arrows[0] as u8 as f32) * 0.023;
        // camera.rotation.x += (self.arrows[1] as u8 as f32) * 0.023;
